<template>
	<img v-if="filteredSelling.length === 0 && Object.values(hotSelling).length === 0"
		src="https://order.makimuraramen.com/assets/loading-C8RNs0gu.gif" alt=""
	...
	<section v-if="filteredSelling.length > 0" class="w-full">
		...
		<div class="rounded-lg">
			<div class="grid grid-cols-2 gap-4">
				<div v-for="(meal) in filteredSelling" :key="meal.name"
					...
					<div class="relative">
						<img class="w-[150px] h-[150px] rounded-[20px] object-contain"
							:src="meal.image_small ?? 'https://order.makimuraramen.com/assets/pic1-BJG-xmCB.jpg'"
							alt="">
